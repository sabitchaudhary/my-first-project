...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <label for="tracking_number">Tracking N.O:</label>
        <input type="text" name="tracking_number" required>

        <label for="date_of_delivery">Date of Delivery:</label>
        <input type="date" name="date_of_delivery" required>
    ...
    // You can store the data in a database, update order status, etc.
    ?>
</body>
<?php
include("footer1.php");
